...
void loop() {
  ...
  switch (proxStatus) {
    ...
    case 1:
      ...
      ledGreen(false);
     avoidObsticale1();
       //her kan man så sætte avoidObsticale2 ind hvis den kommer fra den modsatte side.
...
void avoidObsticale1(){
  ...
  turn( 150, 90, 'l');
       ...
       while (proximityRight >= 4){
        ...
        moveForward (100, 10);
        delay(1000);
        int totalDistance = calculateDistance(encoders.getCountsLeft());
